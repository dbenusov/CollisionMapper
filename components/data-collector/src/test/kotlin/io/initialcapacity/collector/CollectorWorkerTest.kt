...
class CollectorWorkerTest {
    ...
    fun testExecute() {
        ...
        val expected_data = listOf(CollisionData("10018", 32.52434444F, -86.672119440F), CollisionData("10124", 32.58379167F, -86.464288890F), CollisionData("10318", 32.64268056F, -86.756822220F))
